...
import { BookOpen, Plus, Twitter, Instagram, Youtube, Linkedin } from "lucide-react";
...
const Dashboard = () => {
  ...
  if (loading) {
    return <div className="text-center text-[#634419]/60 py-12">Loading...</div>;
  }
          ...
          <Tabs defaultValue="current">
            ...
            <TabsContent value="current">
              <div className="bg-[#CBB296]/10 rounded-xl p-8 border border-[#634419]/20 mt-6">
                {cases.length === 0 ? (
                  <div className="text-center text-[#634419]/60 py-12">No current cases to display</div>
                ) : (
                    ...
                    {cases.map((case_) => (
                      <Sheet key={case_.id}>
                        ...
                        <SheetContent side="right" className="bg-[#DDD0C8] border-l border-[#634419]/20 w-full max-w-lg">
                          {/* Sheet content implementation remains the same */}
                        </SheetContent>
                      </Sheet>
                    ))}
                  </div>
